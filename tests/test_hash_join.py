...
"""Stress-test suite for hash_join.py.
...
class TestUnicodeNormalization:
    ...
    The real risk is Latin diacritics (e.g. "café", "Zürich") where different
    client apps may produce NFC vs NFD for the same display name.
    """
...
class TestCoreUtilities:
    ...
    def test_build_participants_map_display_preserved(self):
        pmap = build_participants_map([{"id": "u1", "display": "Alice Johnson"}])
        assert pmap["u1"] == "Alice Johnson"
